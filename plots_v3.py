...
def make_all_plots(df, model,
    ...
    ax_hosp_tot = plt.subplot2grid((4, 3), (0, 0))
    ax_rt = plt.subplot2grid((4, 3), (0, 1))
    
    ax_hosp = plt.subplot2grid((4, 3), (0, 2))
    ax_a_tot = plt.subplot2grid((4, 3), (1, 0))
    ax_m_tot = plt.subplot2grid((4, 3), (1, 1))
    ax_x_tot = plt.subplot2grid((4, 3), (1, 2))
    
    ax_rho_M = plt.subplot2grid((4, 3), (2, 0))
    ax_rho_X = plt.subplot2grid((4, 3), (2, 1))
    ax_rho_G = plt.subplot2grid((4, 3), (2, 2))
    ax_pi_M = plt.subplot2grid((4, 3), (3, 0))
    ax_pi_X = plt.subplot2grid((4, 3), (3, 1))
    ax_pi_G = plt.subplot2grid((4, 3), (3, 2))
    ...
    asymp_vax_all_days = df.loc[warmup_start:test_end, 'asymp'].values
    asymp_no_vax_all_days = df.loc[warmup_start:test_end, 'asymp'].values 

    mild_vax_all_days = df.loc[warmup_start:test_end, 'mild'].values
    mild_no_vax_all_days = df.loc[warmup_start:test_end, 'mild'].values

    extreme_vax_all_days = df.loc[warmup_start:test_end, 'extreme'].values
    extreme_no_vax_all_days = df.loc[warmup_start:test_end, 'extreme'].values 
