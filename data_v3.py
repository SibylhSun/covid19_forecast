...
def create_warmup(df, warmup_start, warmup_end):
    ...
    warmup_asymp['everyone'] = df.loc[warmup_start:warmup_end, 'asymp'].values 
    warmup_mild['everyone'] = df.loc[warmup_start:warmup_end, 'mild'].values
    warmup_extreme['everyone'] = df.loc[warmup_start:warmup_end, 'extreme'].values 
